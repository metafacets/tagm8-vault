...
Debug.show(tags:[:test],level:4,vars:[['descendants',tax.get_tag_by_name(:mouse).get_descendants]])
Debug.show(tags:[:test],level:4,vars:[['descendants',tax.get_tag_by_name(:mammal).get_descendants]])
Debug.show(tags:[:test],level:4,vars:[['descendants',tax.get_tag_by_name(:animal).get_descendants]])
Debug.show(tags:[:test],level:4,vars:[['ancestors',tax.get_tag_by_name(:carpette).get_ancestors]])
Debug.show(tags:[:test],level:4,vars:[['depth',tax.get_tag_by_name(:carpette).get_depth(tax.get_tag_by_name(:fish),tax.get_tag_by_name(:fish).get_descendants)]])
